...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    m_drive.setDefaultCommand(m_drive.arcadeDrive(m_driverController::getLeftY, m_driverController::getRightX));   
  ...
  public Command getAutonomousCommand() {
    ...
    if (m_autoSelected == kMiddleAuto){
      return Autos.middle(m_drive, m_arm, m_intake);
    } else {
